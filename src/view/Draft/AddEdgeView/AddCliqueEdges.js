...
class AddCliqueEdgesView extends React.Component {
                    ...
                    text: [
                        {
                            ...
                            content: "Input two or more interconnected topics (eg: building, property, structure). To input a topic, type the topic name and press Enter.",
                            disableBeacon: true
                        }
                    ]
                }
                ...
                <div className="addEdgeEntityContainer">                    
                    <Autocomplete
                        ...
                        onChange = {(event, newValue) => {
                            ReactGA.event({
                                category: 'Add clique edge',
                                action: 'Add clique edge secondary '+ String(this.props.bId),
                                label: 'Add clique edge secondary '+ String(this.props.bId)
                              });
                            this.setState({
                ...
                {this.state.selectedEntities.length >= 2?
                    <Button
                        ...
                        <div>
                            ...
                            >Confirm</Button> 
                            <p className="edgeEntityMessage">*Input two or more topics (eg: building, property, structure)! <br/>
...
export default AddCliqueEdgesView;
